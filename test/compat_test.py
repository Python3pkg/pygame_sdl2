...
class CompatModuleTest(unittest.TestCase):
    def test_as_unicode(self):
        ...
        self.assertTrue(isinstance(u, compat.unicode_))
    ...
    def test_as_bytes(self):
        ...
        b = compat.as_bytes(s)
        self.assertTrue(isinstance(b, compat.bytes_))
    ...
    def test_long_(self):
        self.assertTrue(isinstance(int('99999999999999999999'), compat.long_))
    ...
    def test_unichr_(self):
        ...
        self.assertTrue(isinstance(c, compat.unicode_))
    ...
    def test_get_BytesIO(self):
        ...
        b2 = BytesIO(b1).read()
        self.assertTrue(isinstance(b2, compat.bytes_))
    ...
    def test_get_StringIO(self):
        ...
        b1 = "abcde"
        b2 = StringIO(b1).read()
        self.assertTrue(isinstance(b2, str))
        self.assertEqual(b2, b1)
