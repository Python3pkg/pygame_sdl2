...
class SurfarrayModuleTest (unittest.TestCase):
    ...
    def test_get_arraytype(self):
        ...
        self.assertTrue((pygame.surfarray.get_arraytype() in
                         ['numpy', 'numeric']),
...
##
    ...
    def test_pixels2d(self):
        ...
        for surf in sources:
            ...
            if arraytype == "numeric":
                self.assertEqual(surf.get_locks(), (ar,))
    ...
    def test_pixels3d(self):
        ...
        for surf in sources:
            ...
            # Numpy uses the surface's buffer.
            if arraytype == "numeric":
                self.assertEqual(surf.get_locks(), (arr,))
            self._fill_array3d(arr)
            surf.unlock()
            self.assertTrue(surf.get_locked())
            del arr
    ...
    def test_use_arraytype(self):
        ...
        try:
            ...
            self.assertNotEqual(pygame.surfarray.get_arraytype(), 'numpy')
        else:
            pygame.surfarray.use_arraytype('numpy')
        ...
        try:
            ...
            self.assertNotEqual(pygame.surfarray.get_arraytype(), 'numeric')
        else:
            pygame.surfarray.use_arraytype('numeric')
            self.assertEqual(pygame.surfarray.get_arraytype(), 'numeric')
    ...
    def test_surf_lock (self):
        ...
        for atype in pygame.surfarray.get_arraytypes ():
            ...
            # Numpy uses the Surface's buffer.
            if atype == "numeric":
                self.assertEqual (sf.get_locks (), (ar,))
